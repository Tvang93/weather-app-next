    ...
    <div className="grid grid-cols-2 px-[20px] py-[15px] gap-y-1">
      <div className="flex">
        <div className="flex flex-col items-center">
          ...
          <h2 className="text-[48px]">{`${isFahrenheit ? props.highTemp : Math.round((Number(props.highTemp) * 9) / 5 + 32).toString()}°${isFahrenheit ? `F` : `C`}`}</h2>
        </div>
        <div>
          <img
            className="w-[64px]"
      ...
      <div className="flex">
        <div className="flex flex-col items-center">
          ...
          <h2 className="text-[48px]">{`${isFahrenheit ? props.lowTemp : Math.round((Number(props.lowTemp) * 9) / 5 + 32).toString()}°${isFahrenheit ? `F` : `C`}`}</h2>
        </div>
        <div>
          <img
            className="w-[64px]"
